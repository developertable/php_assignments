            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card project-card">
                        <div class="card-body">
                            <h5 class="card-title">
                                <i class="bi bi-person-plus"></i> Assign Incidents
                            </h5>
                            <span class="badge category-admin badge-custom mb-3">Admin</span>
                            <p class="card-text text-muted">
                                Assign unassigned incidents to technicians.
                            </p>
                            <a href="project_6_6_assign_incident/index.php" 
                               class="btn btn-danger w-100">
                                Access Module
                            </a>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card project-card">
                        <div class="card-body">
                            ...
                            <a href="project_6_5_create_incident/customer_login.php" 
                               class="btn btn-primary w-100">
                                Customer Login
                            </a>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card project-card">
                        <div class="card-body">
                            ...
                            <span class="badge category-tech badge-custom mb-3">Technician</span>
                            <p class="card-text text-muted">
                                View and manage assigned support incidents.
                            </p>
                            <a href="project_6_7_display_incidents/technician_login.php" 
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        <strong>Assignment:</strong> 4 - Complete Incident Management System<br>
                ...
                <div class="col-md-6 text-end">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        ✅ Project 6-5: Create Incident<br>
                        ✅ Project 6-6: Assign Incident<br>
                        ✅ Project 6-7: Display & <br>Update Incidents (Technician Dashboard)<br>
                    </p>
                </div>
            </div>
            <hr>
