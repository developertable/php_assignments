...
<html>
<head>
    <title>Incident #<?php echo $incident['incidentID']; ?> Details</title>
            ...
            <div class="col-md-10 mx-auto">
                ...
                <?php if ($incident['dateClosed']): ?>
                    <div class="alert alert-success">
                        <h5><i class="bi bi-check-circle"></i> Incident Closed</h5>
                        <p class="mb-0">
                ...
                <?php else: ?>
                    <div class="alert alert-warning">
                        <h5><i class="bi bi-exclamation-triangle"></i> Incident Open</h5>
                        <p class="mb-0">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <?php if ($incident['dateClosed']): ?>
                                    <span class="badge bg-success fs-6">Closed - Resolved</span>
                                <?php else: ?>
                                    <span class="badge bg-warning text-dark fs-6">Open - In Progress</span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <?php if (!$incident['dateClosed']): ?>
                    <div class="card border-success">
                        <div class="card-header bg-success text-white">
                            <h5 class="mb-0">Close This Incident</h5>
                        </div>
                        <div class="card-body">
                            <p class="mb-3">
                            ...
                            <form action="close_incident.php" method="post" 
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-success btn-lg">
                                        <i class="bi bi-check-circle"></i> Mark as Resolved & Close Incident
                                    </button>
                                    <a href="index.php" class="btn btn-secondary">
                                        Keep Open & Return to Dashboard
                                    </a>
                                </div>
                            </form>
                        </div>
                ...
                <?php else: ?>
                    <div class="card">
                        <div class="card-body text-center">
                            <p class="text-muted mb-3">This incident is closed and cannot be modified.</p>
